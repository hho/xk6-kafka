...
func TestProduce(t *testing.T) {
	...
	assert.Equal(t, 10.0, metricsValues[test.module.metrics.WriterMaxAttempts.Name])
	assert.Equal(t, 1.0, metricsValues[test.module.metrics.WriterMaxBatchSize.Name])
	assert.Equal(t, 1000.0, metricsValues[test.module.metrics.WriterBatchTimeout.Name])
	assert.Equal(t, 10000.0, metricsValues[test.module.metrics.WriterReadTimeout.Name])
	assert.Equal(t, 10000.0, metricsValues[test.module.metrics.WriterWriteTimeout.Name])
